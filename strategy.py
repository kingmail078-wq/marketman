...
def generate_signals(candles: List[Candle], book: Optional[BookSnapshot] = None) -> List[Signal]:
...
def sample_candles() -> List[Candle]:
    return [
        Candle(open=100, high=102, low=99, close=101, volume=1200),
        Candle(open=101, high=103, low=100, close=102, volume=1350),
        Candle(open=102, high=104, low=101, close=103, volume=1400),
        Candle(open=103, high=105, low=102, close=104, volume=1500),
        Candle(open=104, high=106, low=103, close=105, volume=1600),
        Candle(open=105, high=107, low=104, close=106, volume=1700),
        Candle(open=106, high=108, low=105, close=107, volume=1700),
        Candle(open=107, high=109, low=106, close=108, volume=1800),
        Candle(open=108, high=110, low=107, close=109, volume=1900),
        Candle(open=109, high=111, low=108, close=110, volume=2000),
        Candle(open=110, high=112, low=109, close=111, volume=2100),
        Candle(open=111, high=113, low=110, close=112, volume=2200),
        Candle(open=112, high=114, low=111, close=113, volume=2300),
        Candle(open=113, high=115, low=112, close=114, volume=2400),
        Candle(open=114, high=116, low=113, close=115, volume=2500),
        Candle(open=115, high=117, low=114, close=116, volume=2600),
        Candle(open=116, high=118, low=115, close=117, volume=2700),
        Candle(open=117, high=119, low=116, close=118, volume=2800),
        Candle(open=118, high=120, low=117, close=119, volume=2900),
        Candle(open=119, high=121, low=118, close=120, volume=3000),
        Candle(open=120, high=122, low=119, close=121, volume=3100),
        Candle(open=121, high=123, low=120, close=122, volume=3200),
        Candle(open=122, high=124, low=121, close=123, volume=3300),
        Candle(open=123, high=125, low=122, close=124, volume=3400),
    ]
...
if __name__ == "__main__":
    ...
    for signal in signals:
        print(f"Signal at index {signal.index}: {signal.signal} - {signal.reason}")
